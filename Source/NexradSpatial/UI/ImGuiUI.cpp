...
void ImGuiUI::MainUI()
{
	...
	if(ImGui::Begin("NexradSpatial", NULL, ImGuiWindowFlags_NoMove | /*ImGuiWindowFlags_NoBackground |*/ ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_HorizontalScrollbar)){
		...
		if (ImGui::CollapsingHeader("Settings")) {
			...
			if (ImGui::TreeNodeEx("Integration", ImGuiTreeNodeFlags_SpanAvailWidth)) {
				...
				CustomTooltipForPrevious("Show NexradSpatial on discord");
				ImGui::TreePop();
			}
